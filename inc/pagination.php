...
if ( ! function_exists( 'stylewp_pagination' ) ) {
	/**
	 ...
	 */
	function stylewp_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'stylewp' ),
				'next_text'          => __( '&raquo;', 'stylewp' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'stylewp' ),
			)
		);
